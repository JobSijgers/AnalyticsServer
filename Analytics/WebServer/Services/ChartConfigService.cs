...
public class ChartConfigService
{
    ...
    public async Task<List<EventDisplayConfig>> LoadAllActiveConfigs()
    {
        try
        {
    ...
    public async Task<EventDisplayConfig?> GetConfigById(string id)
    {
        return await _configs.Find(c => c.Id == id).FirstOrDefaultAsync();
    }

    public async Task SaveConfig(EventDisplayConfig config)
    {
        try
        {
    ...
    public async Task DeleteConfig(string id, string projectId)
    {
        try
        {
    ...
    public async Task<long> DeleteConfigsForProject(string projectId)
    {
        try
        {
    ...
    public async Task UpdateConfigOrders(string projectId, List<ChartOrder> orders)
    {
        try
        {
